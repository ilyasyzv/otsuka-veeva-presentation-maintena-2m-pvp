...
import A_5_1_1_Patients_support_providers from '@/content/pages/A.5.1.1_Patients_support_providers/index.mdx';
import A_5_1_2_Patients_support_providers from '@/content/pages/A.5.1.2_Patients_support_providers/index.mdx';
import A_6_1_1_Appendix_Safety from '@/content/pages/A.6.1.1_Appendix_Safety/index.mdx';
import A_6_2_1_Apendix_MOA from '@/content/pages/A.6.2.1_Apendix_MOA/index.mdx';
import A_6_3_1_Apendix_Safety from '@/content/pages/A.6.3.1_Apendix_Safety/index.mdx';
      ...
      <Suspense fallback={<h1>Loading application...</h1>}>
        <PageProvider>
          <Layout>
            ...
            <Route path='/A.3.3.1_Safety' component={() => <Page component={A_3_3_1_Safety} />} />
            <Route path='/A.3.3.2_Safety' component={() => <Page component={A_3_3_2_Safety} />} />
            <Route path='/A.3.3.3_Safety' component={() => <Page component={A_3_3_3_Safety} />} />
            <Route path='/A.3.3.4_Safety' component={() => <Page component={A_3_3_4_Safety} />} />
            <Route path='/A.3.4.1_Dosing' component={() => <Page component={A_3_4_1_Dosing} />} />
            ...
            <Route path='/A.5.1.1_Patients_support_providers' component={() => <Page component={A_5_1_1_Patients_support_providers} />} />
            <Route path='/A.5.1.2_Patients_support_providers' component={() => <Page component={A_5_1_2_Patients_support_providers} />} />
            <Route path='/A.6.1.1_Appendix_Safety' component={() => <Page background='a' component={A_6_1_1_Appendix_Safety} />} />
            <Route path='/A.6.2.1_Apendix_MOA' component={() => <Page component={A_6_2_1_Apendix_MOA} />} />
            <Route path='/A.6.3.1_Apendix_Safety' component={() => <Page component={A_6_3_1_Apendix_Safety} />} />
