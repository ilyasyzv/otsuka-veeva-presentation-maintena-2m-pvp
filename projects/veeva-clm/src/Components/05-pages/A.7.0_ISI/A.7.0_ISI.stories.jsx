    ...
    <div className={`${baseClass}-wrapper`}>
      ...
      >
        ...
        <Paragraph>
          ...
          Clinical signs of NMS are hyperpyrexia, muscle rigidity, altered
          mental status and evidence of autonomic instability. Additional signs
          may include elevated creatine phosphokinase, myoglobinuria
          (rhabdomyolysis), and acute renal failure. Manage NMS with immediate
          discontinuation of ABILIFY MAINTENA, intensive symptomatic treatment,
          and monitoring.
        </Paragraph>
        <Paragraph>
          ...
          at low doses, or after discontinuation of treatment. Prescribing
          should be consistent with the need to minimize TD. If antipsychotic
          treatment is withdrawn, TD may remit, partially or completely.
        </Paragraph>
        <Paragraph>
            ...
            data: [
              {
                text: (
                  <span>
                    ...
                    with risk factors for diabetes (e.g., obesity, family
                    history of diabetes), should undergo baseline and periodic
                    fasting blood glucose testing. Any patient treated with
                    atypical antipsychotics should be monitored for symptoms of
                    hyperglycemia including polydipsia, polyuria, polyphagia,
              ...
              },
              {
                text: (
                  <span>
                    ...
                    with atypical antipsychotic use. Clinical monitoring of
        ...
        <Paragraph>
          ...
          should ask patients or their caregivers about the development of new
          or intense compulsive urges. Consider dose reduction or stopping
          aripiprazole if such urges develop.
        </Paragraph>
        <Paragraph>
          <strong>Orthostatic Hypotension:</strong> ABILIFY MAINTENA may cause
          orthostatic hypotension and should be used with caution in patients
        ...
        <Paragraph>
          ...
          in WBC and in severely neutropenic patients.
        </Paragraph>
        <Paragraph>
          <strong>Seizures:</strong> ABILIFY MAINTENA should be used with
        ...
        <Paragraph>
          ...
          patients to avoid operating hazardous machinery, including
          automobiles, until they are certain ABILIFY MAINTENA does not affect
          them adversely.
        </Paragraph>
        <Paragraph>
          <strong>Body Temperature Regulation:</strong> Use ABILIFY MAINTENA
          with caution in patients who may experience conditions that increase
          body temperature (e.g., strenuous exercise, extreme heat, dehydration,
        ...
        <Paragraph>
          <strong>Alcohol:</strong> Advise patients to avoid alcohol while
          taking ABILIFY MAINTENA.
        </Paragraph>
        <Paragraph>
          ...
          patients taking concomitant CYP3A4 inhibitors or CYP2D6 inhibitors for
          greater than 14 days. Avoid concomitant use of CYP3A4 inducers with
          ABILIFY MAINTENA for greater than 14 days. Dosage adjustments are not
        ...
        <Paragraph>
          ...
          trial with ABILIFY MAINTENA in patients with schizophrenia treated
          with gluteal administered ABILIFY MAINTENA, the percent of patients
          reporting any injection site-related adverse reaction was 5.4%, and
          0.6% for placebo. In an open label study of ABILIFY MAINTENA
          administered in the deltoid or gluteal muscle, injection site pain was
        ...
        <Paragraph>
          ...
          including ABILIFY MAINTENA, during the third trimester of pregnancy
          are at risk for extrapyramidal and/or withdrawal symptoms. Consider
          the benefits and risks of ABILIFY MAINTENA and possible risks to the
          fetus when prescribing ABILIFY MAINTENA to a pregnant woman. Advise
