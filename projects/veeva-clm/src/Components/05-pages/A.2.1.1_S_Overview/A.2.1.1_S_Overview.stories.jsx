...
import AnimationSchizophrenia from '@/Components/02-molecules/AnimationSchizophrenia/AnimationSchizophrenia';
import './style.scss';
...
const content = () => (
  <>
    <Header custom={`${baseClass}-header-1 mb-35`}>
      Schizophrenia is a chronic and severe psychiatric disorder affecting ~1.1%
      of US adults<sup>1,2</sup>
    </Header>
