...
const content = () => (
  <>
    ...
    <img className={`${baseClass}-img-1 mt-43`} src={PageImage1} alt='' width='835' />

    <Header custom={`${baseClass}-header-2 text-center m-20 blue-500`} type={'h2'}>
      Administered by a health care professional once every 2 months by<br/>
    ...
    <Footer
      ...
      footnotes={{
        ...
        data: [
          {
            supLeft: '*',
            innerText: <span>720 mg is available for patients who cannot tolerate the 960-mg dose.</span>
          }
        ]
      }}
      safetyInfo={{
        data: [
          {
            text: <span>Please see <a href="/" className={'blue-500'}>IMPORTANT SAFETY INFORMATION</a> in this presentation.</span>,
          },
          {
