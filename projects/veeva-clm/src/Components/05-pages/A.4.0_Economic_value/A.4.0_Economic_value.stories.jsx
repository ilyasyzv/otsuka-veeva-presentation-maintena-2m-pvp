...
const content = () => {
  return (
    ...
    <Header custom='mb-100'>
      Economic value of ABILIFY MAINTENA<sup>®</sup>(aripiprazole) in schizophrenia and bipolar I disorder<sup>1,2</sup>
    </Header>
        ...
        data: [
          {
            text: (
              <span>
                Merative Micromedex. Accessed March 22, 2023. https://www.micromedexsolutions.com/
              </span>
            ),
          },
          {
