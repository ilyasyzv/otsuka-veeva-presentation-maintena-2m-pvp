...
const PageContent = () => (
  <div className={styles.page}>
    <Header type="h1">The clinical profile of ABILIFY
      ASIMTUFII<sup>®</sup> (aripiprazole) in<br/> the treatment of schizophrenia and
      bipolar I disorder is<br/> supported in part by the established efficacy and
      safety of<br/> ABILIFY MAINTENA® (aripiprazole)</Header>
    
    <div className={"card"}>
  
      <Header type="h2">ABILIFY MAINTENA Efficacy in Schizophrenia and Bipolar I Disorder</Header>
