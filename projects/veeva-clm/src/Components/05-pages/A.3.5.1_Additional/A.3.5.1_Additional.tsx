      ...
      <div className={'buttons-group'}>
        <div className={'buttons-group-row'}>
          <Link
            ...
            <div className={'button__text'}>Short-term Study:<br/>Schizophrenia
            </div>
          </Link>
          <Link
            to={'A.3.5.4_Additional'}
            custom={'button button__type-c button__type-c-large button__type-c-large-blue'}>
            <div className={'button__text'}>Long-term Study:<br/>Schizophrenia
            </div>
          </Link>
          <Link
            ...
            <div className={'button__text'}>
              Long-term Study:<br/>Bipolar I Disorder
            </div>
          </Link>
        </div>
      </div>
