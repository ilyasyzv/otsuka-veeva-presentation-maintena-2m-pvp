  ...
  <>
   ...
   <Header custom={`${baseClass}-header-2 mb-25`}>
    ...
    <img src={Placebo_image} alt='placebo' className='placebo ml-15 mb-57' />
      <Paragraph position='center' custom={'mt-3'}>The HR was used to calculate the reduction in risk of relapse<br/> for patient on ABILIFY MAINTENA vs placebo.<sup>1</sup></Paragraph>
